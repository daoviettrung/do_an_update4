            ...
            <div class="col-lg-9">
                    ...
                    <div class="col-md-2">
                        ...
                        @if($post->id==$idTick)
                            <form style="margin-top: 20px" method="post"
                                  action="admin/manage-user/ban/{{$post->author_id}}">
                                @csrf
                    ...
                    <div class="col-md-10">
                        ...
                        @if($post->id==$idTick)
                            <form style="margin-top: 25px" method="post"
                                  action="admin/manage-post/delete/{{$post->id}}">
                                @csrf
                                <button onclick="return confirm('Do you really want to delete the post, press ok ' +
                             ' to confirm?')" ;>Delete post
                                </button>
                            </form>
                        @endif
                    </div>
                ...
                @foreach($comments as $comment)
                    <div class="row-item row">
                        ...
                        <div class="media col-md-{{12-$level}} bor der-left"
